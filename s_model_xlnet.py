...
class LiarPlusStatementsClassifierXLNet(nn.Module):
    def __init__(self, encoder_model, num_classes):
        super(LiarPlusStatementsClassifierXLNet, self).__init__()
    ...
    def forward(self, input_ids, attention_mask):
        ...
        cls_output = outputs.last_hidden_state[:, -1, :]  # Use [CLS] token output
