...
- verbosity (Redundancja) - artykuł powtarza te same informacje bez dodawania nowej wiedzy (1 - powtarza, 0 - dodaje nowe informacje).
...
- truthfulness (Prawdziwość) - dodatkowe informacje zawarte w artykule są prawdziwe (2 - tak, 1 - częściowo tak, 0 - fałszywe/nic nie dodaje)
